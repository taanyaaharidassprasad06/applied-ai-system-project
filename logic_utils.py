...
def update_score(current_score: int, outcome: str, attempt_number: int):
    ...
    if outcome == "Win":
        # TO FIX: attempt_number is already 1-indexed in the app, so this scoring system is harsher than intended because it subtracts 10 more points than expected on each attempt
    ...
    # TO FIX: To High rewarded points on every other too high guess
